  ...
  try {
    ...
    if (summary.price == null) {
      ...
      return res.json({
        ...
        currency: "USD",
        metrics: { open: liveQuote.open, previousClose: liveQuote.previousClose, high: liveQuote.high, low: liveQuote.low, volume: null, avgVolume: null, marketCap: null },
        profile: {}, indicators: {}, history: {}, dividends: [], events: []
      });
    }
